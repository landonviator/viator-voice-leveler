...
NavBar::NavBar(ViatorvoicelevelerAudioProcessor& p) : audioProcessor(p), _presetBrowser(audioProcessor)
{
    // shadow
...
{
    auto* parent = dynamic_cast<ViatorvoicelevelerAudioProcessorEditor*>(getParentComponent()->getParentComponent());
