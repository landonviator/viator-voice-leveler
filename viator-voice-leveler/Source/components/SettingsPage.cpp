...
SettingsPage::SettingsPage(ViatorvoicelevelerAudioProcessor& p) : audioProcessor(p)
{
    // labels
    int index = 0;
    initThemeLabelProps();
...
void SettingsPage::initThemeMenuProps()
{
    ...
    {
        auto* parent = dynamic_cast<ViatorvoicelevelerAudioProcessorEditor*>(getParentComponent());
